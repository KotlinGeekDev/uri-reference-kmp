...
@JvmOverloads constructor(params: MutableList<QueryParam?>? = ArrayList(0)) {
     ...
     * 
     * @param params
     * The list of [org.czeal.urireference.QueryParam] objects to be included in the [         ].
     * 
    ...
    companion object {
         ...
         * each occurrence is added as a separate [org.czeal.urireference.QueryParam] object in the
         * [QueryParams] object.
         * 
         * 
         * @param queryParams
