 ...
 * succeeds, this method creates a [org.czeal.urireference.Host] object. If parsing fails due to
...
internal class HostParser {
     ...
     * a [org.czeal.urireference.Host] instance if parsing succeeds. If parsing fails due to invalid
