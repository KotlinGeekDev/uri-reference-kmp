...
class SegmentNzValidatorTest {
    @Test
    fun test_validate() {
        SegmentNzValidator().validate("abcde12345-._~", Charsets.UTF8)
        SegmentNzValidator().validate("()+_", Charsets.UTF8)
        SegmentNzValidator().validate("!$&'()*+,;=", Charsets.UTF8)
        SegmentNzValidator().validate("@", Charsets.UTF8)
        ...
        assertThrowsNPE<Throwable>(
            ...
            { SegmentNzValidator().validate(null, Charsets.UTF8) })
    }
}
