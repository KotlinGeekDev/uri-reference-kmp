...
class AuthorityNormalizerTest {
    ...
    fun test_normalize() {
        val normalized1 = AuthorityNormalizer().normalize(
            Authority.parse("userinfoABC@EXAMPLE.com:80"), StandardCharsets.UTF_8, "http"
        )
        ...
        val normalized2 = AuthorityNormalizer().normalize(
            Authority.parse("userinfoABC@EXAMPLE.com:443"), StandardCharsets.UTF_8, "https"
        )
        ...
        val normalized3 = AuthorityNormalizer().normalize(null, StandardCharsets.UTF_8, "http")
