 ...
 * @author Hideki Ikeda
 */
internal abstract class PercentEncodedStringNormalizer : PercentEncodedStringProcessor() {
    ...
    override fun onNonPercent(
        ...
        // value as-is.
        val normalized = if (toLowerCase()) c.lowercaseChar() else c
    ...
    override fun onMalformedPercentEncodedValue(
        ...
        // This won't happen.
        throw Utils.newISE("onMalformedPercentEncodedValue() is not supposed to be called.")
    }
    ...
    override fun onInvalidHexDigit(
        ...
        // This won't happen.
        throw Utils.newISE("onInvalidHexDigit() is not supposed to be called.")
    }


    override fun onDecodeFailed(input: String, info: Info?): IllegalArgumentException {
        // This won't happen.
        throw Utils.newISE("onDecodeFailed(input) is not supposed to be called.")
    }
     ...
     * Whether or not lower-case characters are required for the component.
     */
    protected abstract fun toLowerCase(): Boolean
}
