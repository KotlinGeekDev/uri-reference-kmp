 ...
 * 
 * 
 * Note that the normalization doesn't modify the state of the given [Authority]
 * object. Instead, it creates a new [Authority] object and initializes it
...
internal class AuthorityNormalizer {
     ...
     * the state of the original [Authority] object on which this method is
     * called. Instead, it creates a new [Authority] object with the normalized
     * `authority` information.
     * 
     * @param authority
     * An [Authority] object to normalize.
     * 
     * @param charset
     ...
     * 
     * @return
     * The [Authority] object representing the normalized `authority`
     * component.
     * 
     * @see [RFC 3986,
     * Section 6: Normalization and Comparison](https://www.rfc-editor.org/rfc/rfc3986.section-6)
