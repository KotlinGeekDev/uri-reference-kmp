 ...
 * 
 * 
 * A builder class for constructing [Authority] objects.
 * 
 * 
 * 
 * This class provides a fluent API to build an [Authority] object incrementally
...
internal class AuthorityBuilder {
     ...
     * 
     * @return
     * An [Authority] object representing the resultant `authority`
     * component.
     */
    fun build(): Authority {
