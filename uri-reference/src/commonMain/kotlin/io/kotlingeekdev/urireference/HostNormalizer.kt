...
internal class HostNormalizer : PercentEncodedStringNormalizer() {
     ...
     * 
     * 
     * This method does not modify the state of the original [Host] object
     * on which this method is called. Instead, it creates a new [Host] object
     * with the normalized host information.
     * 
     * 
     * @param host
     * A [Host] object to normalize.
     * 
     * @param charset
     ...
     * 
     * @return
     * The [Host] object representing the normalized host.
     * 
     * @see [RFC 3986,
     * Section 6: Normalization and Comparison](https://www.rfc-editor.org/rfc/rfc3986.section-6)
     */
