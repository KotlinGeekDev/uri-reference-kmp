...
import io.kotlingeekdev.urireference.URIReference.Companion.parse
import io.kotlingeekdev.urireference.URIReferenceBuilder.Companion.fromURIReference
...
class URIReferenceBuilderTest {
    ...
    fun test_setPathSegments() {
        ...
        TestUtils.assertThrowsNPE<Throwable>("A segment must not be null.", {
    ...
    fun test_appendQueryParam() {
        ...
        TestUtils.assertThrowsNPE<Throwable>("The key must not be null.", {
            fromURIReference("http://example.com")
